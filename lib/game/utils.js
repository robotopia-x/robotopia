...
function isFieldEmpty (game, x, y) {
  if (game.tiles[y] === undefined || game.tiles[y][x] === undefined || game.tiles[y][x] === 0) {
    return false
  }
...
// searches for empty field by iterating over every game field in a square spiral around the target field
function getEmptyFieldNearPosition (game, x, y) {
